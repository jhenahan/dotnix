...
CACHE = /Users/jackhenahan/Documents/NixCache
ROOTS = /nix/var/nix/gcroots/per-user/jackhenahan/shells
...
mirror:
	...
	git --git-dir=darwin/.git push --mirror jhenahan
	git --git-dir=home-manager/.git push --mirror jhenahan
